...
class Method(ABC):
    ...
    def gradient_from(self, calc: "CalculationExecutor", file_identifier="") -> Gradient:
        raise NotImplementedInMethod
...
class ExternalMethod(Method, ABC):
    ...
    def energy_from(self, calc: "CalculationExecutor", file_identifier="") -> PotentialEnergy:
        """
        ...
        energy = self._energy_from(calc, file_identifier="")
